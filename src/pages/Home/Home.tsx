              ...
              return (
                <SectionReveal key={card.title} delay={index * 0.06}>
                  <motion.article
                    ...
                    className="h-full rounded-[1.6rem] border border-white/10 bg-white/5 p-6 shadow-[0_18px_50px_rgba(0,0,0,0.2)] backdrop-blur-sm"
                  >
              ...
              <SectionReveal key={industry.id} delay={index * 0.05}>
                ...
                >
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0f1534]/75 via-[#0f1534]/15 to-transparent" />
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            {vendorChallenges.map((item, index) => (
              <SectionReveal key={item.id} delay={index * 0.05}>
                <motion.article
                  whileHover={{ y: -6 }}
                  className="rounded-[1.7rem] border border-border bg-[#fbfcff] p-7 shadow-soft"
                >
                  <div className="text-xs font-bold uppercase tracking-[0.26em] text-brand">
                    Your IT challenges
                  </div>
